...
let headerHTML = '<ul> <li><a href="' + relativePath + '/index.html">Blog Home</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">Archive</a></li>' +
'<li><a href="' + relativePath + '/about.html">About</a></li> </ul>' +
'<li><a href="https://www.nerveship.net/">Site Home</a></li> </ul>';
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>";
